...
-spec quorum_max(peer(), #config{} | [], dict:dict(atom(), non_neg_integer())) -> non_neg_integer().
...
-spec quorum(peer(), #config{} | list(), dict:dict(atom(), boolean())) -> boolean().
...
-spec sorted_values(peer(), [peer()], dict:dict(atom(), non_neg_integer())) -> [non_neg_integer()].
...
-spec value(peer(), dict:dict(atom(), non_neg_integer())) -> non_neg_integer().
