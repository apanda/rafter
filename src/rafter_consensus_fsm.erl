...
-spec reconfig(term(), dict:dict(atom(), non_neg_integer()), #config{}, list(), #state{}) 
                                     -> {dict:dict(atom(), non_neg_integer()), #config{}}.
...
-spec add_followers(list(), 
            dict:dict(atom(), non_neg_integer()), #state{}) 
                    -> dict:dict(atom(), non_neg_integer()).
...
-spec remove_followers(list(), 
        dict:dict(atom(), non_neg_integer())) -> dict:dict(atom(), non_neg_integer()).
